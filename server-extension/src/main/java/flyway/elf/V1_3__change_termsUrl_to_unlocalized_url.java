 ...
 */
public class V1_3__change_termsUrl_to_unlocalized_url implements JdbcMigration {
    private static final Logger LOG = LogFactory.getLogger(V1_3__change_termsUrl_to_unlocalized_url.class);
