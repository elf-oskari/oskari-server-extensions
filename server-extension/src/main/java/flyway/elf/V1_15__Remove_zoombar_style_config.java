...
/**
 * Removed style settings from zoom/pan buttons since frontend code has changed and they are not needed anymore
 */
public class V1_15__Remove_zoombar_style_config implements JdbcMigration {

    private static final Logger LOG = LogFactory.getLogger(V1_15__Remove_zoombar_style_config.class);
