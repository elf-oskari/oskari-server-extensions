...
INSERT INTO oskari_maplayer(type, name, groupId,
  ...
  VALUES('wfslayer', 'oskari:vuser_layer_data', (SELECT MAX(id) FROM oskari_layergroup),
  		 15000000, 1,
         80, 'http://localhost:8080/geoserver/oskari/ows', 'admin', 'geoserver', '1.1.0', 'EPSG:3857', '{ fi:{name:"Omat aineistot",subtitle:""},sv:{name:"User layers",subtitle:""},en:{name:"User layers",subtitle:""}}');
