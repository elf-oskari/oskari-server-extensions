...
INSERT INTO oskari_maplayer(type, name, groupId, 
                            minscale, maxscale, 
                             ...
                             locale) 
  VALUES('wfslayer', 'elf_HYP_lm_se', 904, 
         500000, 1, 
          'http://download-ver.lantmateriet.se/elf/v1.0/wfs/hy', 'maan0001', 'r3jtqJE2TQS6M862f',  'urn:ogc:def:crs:EPSG::3857', '2.0.0',
          '{fi:{name:"HY-P Watercouse - lm.se", subtitle:"Lantmeteriet.se"},sv:{name:"HY-P Watercouse - lm.se", subtitle:"Lantmeteriet.se"},en:{name:"HY-P Watercouse - lm.se", subtitle:"Lantmeteriet.se"}}');
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://download-ver.lantmateriet.se/elf/v1.0/wfs/hy+elf_HYP_lm_se');
