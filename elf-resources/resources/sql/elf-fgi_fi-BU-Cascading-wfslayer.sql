...
VALUES (
	...
	'fi.nls.oskari.eu.elf.recipe.buildings.ELF_MasterLoD0_Building_nls_fi_wfs_Parser');          
   ...
   max_features, 
    ...
    VALUES ( (select max(id) from oskari_maplayer), 
      'ELF_BU_fgi_fi', 
       ...
       'elf-lod0bu', 
       '', 
       '{"default" : "*geometry:Geometry,beginLifespanVersion:String,endLifespanVersion:String}', 
       '{}', 
       '{}', 
       '2d', 
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://54.228.221.191/ELFcascadingWFS/service+elf_bu_fgifi');
