...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_HY_fgi_fi', 906, 
         500000, 1, 
          ...
          '{fi:{name:"HY Hydrography - fgi.fi", subtitle:"Cascading"},sv:{name:"HY Hydrography - fgi.fi", subtitle:"Cascading"},en:{name:"HY Hydrography - fgi.fi", subtitle:"Cascading"}}');
...
VALUES (
	...
	'fi.nls.oskari.eu.elf.recipe.hydronetwork.ELF_MasterLoD1_WatercourseLink_Parser');          
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://54.228.221.191/ELFcascadingWFS/service+elf_HY_fgi_fi');
